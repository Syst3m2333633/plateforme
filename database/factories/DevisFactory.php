...
class DevisFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        foreach($clients as $client){
            ...
            return [
                'name' => $this->faker->randomElement($array = array('Mise à jour', 'Ajout de fonctionnalité', 'Migration de serveur', 'Débogage', 'Transfert de BDD', 'Correction général', 'Création de site internet vitrine', 'création site e-commerce')),
