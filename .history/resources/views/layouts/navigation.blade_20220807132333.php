        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('devis.show', ['client' => auth()->user()->id])" :active="request()->routeIs('devis.show')">
                        {{ __('Devis') }}
                    </x-nav-link>
                    <x-nav-link :href="route('facture.show', ['client' => auth()->user()->id])" :active="request()->routeIs('facture.show')">
                        {{ __('Factures') }}
                    </x-nav-link>
                    <x-nav-link :href="route('event.create')" :active="request()->routeIs('event.create')">
                        {{ __('Evènement') }}
