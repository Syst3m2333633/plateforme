            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (auth()->user()->isNotAn('admin'))
                        <x-nav-link :href="route('devis.indexe', ['client' => auth()->user()->id])" :active="request()->routeIs('devis.indexe')">
                            {{ __('Devis') }}
                        </x-nav-link>
                        <x-nav-link :href="route('facture.indexe', ['client' => auth()->user()->id])" :active="request()->routeIs('facture.indexe')">
                            {{ __('Factures') }}
                        </x-nav-link>
                        <x-nav-link :href="route('event.create')" :active="request()->routeIs('event.create')">
                            {{ __('Evènement') }}
