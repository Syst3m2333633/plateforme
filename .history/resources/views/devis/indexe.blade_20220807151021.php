                        ...
                        <td>
                                {{-- @if ($clients->id == $devis->client_id) --}}
                                    <form>
                                        @csrf
                                        {{-- ligne fonctionnelle --}}
                                        {{ $devis->name }}<a href="{{ route('devis.download', ['devi' => $devis->client_id])}}" class="btn"><img src="{{ asset('images/bootstrap.svg')}}" style="background-color:green;" with="10" alt="download"/></a>
                                    </form>
                                    {{-- @endif --}}
                        </td>
                    </tr>
