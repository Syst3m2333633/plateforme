        ...
        <div class="row card text-white bg-dark">
            ...
            <div class="card-body">
                ...
                <input type="file" class="dropzone form-control @error('file') is-invalid @enderror" name="file"
                    id="file"
                    value="https://www.fichier-pdf.fr/telecharger/?hash=mZ8rz8i9Ov1ygjZrHU56b4WH2SDrQ3zo7OF1J2z0KS25cMPsupKI0zFVO9Y2CmG8GR674BJ2P5W9D4wz7f1s4iNXRV020xttor10g11ZCz422Du9FXXqW3Y26TQq2Y07">{{ old('file') }}
                --}}
            </div>
