                                    ...
                                    @foreach ($factures as $facture)
                                        {{-- @if ($clients->id == $facture->client_id) --}}
                                            ...
                                            <form>
                                                ...
                                                {{-- {{user->name}} --}}
                                                {{-- ligne fonctionnelle --}}
                                                {{ $factures->name }}<a href="{{ route('facture.download', ['facture' => $facture->client_id])}}" class="btn"><img src="{{ asset('images/bootstrap.svg')}}" style="background-color:green;" with="10" alt="download"/></a>
                                                {{--  --}}
